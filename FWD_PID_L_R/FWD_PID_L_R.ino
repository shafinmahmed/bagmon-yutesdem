...
void loop() {  
  if ((getDistanceRight() < 30.0) || (getDistanceLeft() < 30.0)) {
    goStraight(millis());
    Serial.print("DIST R: "); Serial.print(getDistanceRight()); Serial.print ("     DIST L: "); Serial.print(getDistanceLeft()); Serial.print("    DIST F: "); Serial.print(getDistanceFront()); Serial.print("    YAW: "); Serial.println(getYawDeg()); 
  }
  else {
    //turnLeft90();
    Serial.println("SHAFIN");
  }
}

void goStraight(long startTime) {

  if ((getDistanceRight() > 30.0) || (getDistanceLeft() > 30.0) || getDistanceFront() < 8.00) {
    allMotorStop();
    return;
  }
